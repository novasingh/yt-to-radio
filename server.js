...
if (cluster.isMaster) {
    ...
    // Initially fork MIN_WORKERS (2 workers) to save memory; auto-scaler will handle the rest
    ...
    setInterval(() => {
        ...
        // 1. AUTO-SCALE UP: If avg connections per worker exceed 500, spawn a new worker
    ...
    // Binds the Express app to the shared dynamic port
